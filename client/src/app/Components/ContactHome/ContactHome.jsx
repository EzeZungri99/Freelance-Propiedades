...
export default function ContactHome () { 
    ...
    return(
        ...
        <div className="w-full h-screen bg-blue-gray-600 flex items-center justify-center">
            <div className="w-1/2">
                <Image className="" src="https://i.ibb.co/DLmNsgx/bgn-home-01.jpg" width={800} height={800}/>
            </div>

        <form className="w-1/2 max-w-lg justify-center ">
